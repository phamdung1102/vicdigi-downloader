...
export const TEXT = {
  ...
  update: {
    localMissing: '\\u0043h\\u01b0a c\\u00e0i',
    title: 'Ki\\u1ec3m tra c\\u1eadp nh\\u1eadt',
    close: '\\u0110\\u00f3ng',
    downloading: '\\u0110ang t\\u1ea3i...',
    retry: 'Th\\u1eed l\\u1ea1i',
    hasUpdate: 'C\\u00f3 b\\u1ea3n c\\u1eadp nh\\u1eadt m\\u1edbi',
    doUpdate: 'C\\u1eadp nh\\u1eadt ngay',
    install: '\\u0043\\u00e0i \\u0111\\u1eb7t ngay',
    missingYtdlp: '\\u0043h\\u01b0a c\\u00e0i yt-dlp',
    upToDate: '\\u0042\\u1ea1n \\u0111ang d\\u00f9ng phi\\u00ean b\\u1ea3n m\\u1edbi nh\\u1ea5t',
    unavailable: '\\u004b\\u0068\\u00f4ng th\\u1ec3 ki\\u1ec3m tra c\\u1eadp nh\\u1eadt l\\u00fac n\\u00e0y',
    failed: message => `L\\u1ed7i: ${message}`,
    success: version => `C\\u1eadp nh\\u1eadt th\\u00e0nh c\\u00f4ng! Phi\\u00ean b\\u1ea3n: ${version}`,
  },
  session: {
  ...
  profiles: {
    ...
    persistenceFallback: 'L\\u01b0u tr\\u1ea1ng th\\u00e1i: d\\u1ef1 ph\\u00f2ng qua store',
    persistenceActive: (jobCount, dbPath) => `L\\u01b0u tr\\u1ea1ng th\\u00e1i: SQLite \\u0111ang ho\\u1ea1t \\u0111\\u1ed9ng · ${jobCount} t\\u00e1c v\\u1ee5 · ${dbPath}`,
  },
  downloadCenter: {
